 ...
 // for(var i=0;i<lineRecords.length;i++){
     ...
     { 
          index_country=lineRecords.indexOf("\"Country Name\""); 
           index_population2010=lineRecords.indexOf("\"GDP Billions (US$) - 2010\"");
            index_population2011=lineRecords.indexOf("\"GDP Billions (US$) - 2011\"");
             index_population2012=lineRecords.indexOf("\"GDP Billions (US$) - 2012\"");
          index_population2013=lineRecords.indexOf("\"GDP Billions (US$) - 2013\""); 
         }
...
/*
 ...
 if(flag==1)
 {
   ...
   tempData1["Gdp"]=sum_Asia;
   tempData2["Gdp"]=sum_Europe;
   tempData3["Gdp"]=sum_Africa;
   tempData4["Gdp"]=sum_America;
   tempData5["Gdp"]=sum_Australia;
   ...
   jsonData=result;
    fs.writeFileSync("data4b.json",JSON.stringify(jsonData),encoding="utf8");
